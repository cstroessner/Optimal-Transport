...
% The Gibbs kernel needs to be provided as Line Graph in terms of K12 K23 K34

function [x1, x2, x3, x4, err, usedIters, success] = MMSinkhorn4LineGraph(K12,K23,K34, a, b, c, d, maxIters, tol, disableWarnings)
...
% Sinkhorn iterations
for iter = 1:maxIters
    [s1,s2,s3,s4] = computeMarginals(K12,K23,K34,x1,x2,x3,x4);
...
function [s1,s2,s3,s4] = computeMarginals(K12,K23,K34,x1,x2,x3,x4)
